package main.scala.class1.clustering.kmeans
...
object kmeanstest1 {
  def main(args: Array[String]) {
    ...
    // 设置运行环境
    val conf = new SparkConf().setAppName("kmeanstest1").setMaster("local")
    val sc = new SparkContext(conf)

    // 装载数据集
    val data = sc.textFile("file:///D:/Workspaces/IdeaProjects/SCALA_PROJECTS/data/spark_test_0.1/kmeanstest1/in/data.txt", 1)
    ...
    result1.saveAsTextFile("file:///D:/Workspaces/IdeaProjects/SCALA_PROJECTS/data/spark_test_0.1/kmeanstest1/out1")
    ...
    val result2 = data.map {
      line =>
        ...
        line + " " + prediction
    }.saveAsTextFile("file:///D:/Workspaces/IdeaProjects/SCALA_PROJECTS/data/spark_test_0.1/kmeanstest1/out2")
